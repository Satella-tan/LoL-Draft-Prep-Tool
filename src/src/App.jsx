...
const DraftPrepNotebook = () => {
  ...
  const importPrep = (e) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        const ids = getAllNodeIds(importedPrep.nodes || []);
        const expanded = {};
  ...
  const renderNode = (node, level = 0) => {
    ...
    const indent = Math.min(level, 12) * 12;
      ...
      <div key={node.id} style={{ paddingLeft: indent + 'px' }}>
        <div
          style={{
            ...
            alignItems: 'center',
            padding: '6px 8px',
            backgroundColor: isSelected ? '#2a2149' : 'transparent',
            borderRadius: '4px',
            cursor: 'pointer',
            marginBottom: '2px'
          }}
          onMouseEnter={(e) => e.currentTarget.style.backgroundColor = isSelected ? '#2a2149' : '#171734'}
          onMouseLeave={(e) => e.currentTarget.style.backgroundColor = isSelected ? '#2a2149' : 'transparent'}
        >
          <div
          ...
          <div style={{ display: 'flex', gap: '4px', marginLeft: '8px' }}>
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#b0b4c4', padding: '2px' }}
            >
              <Edit2 size={14} />
            </button>
            <button
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', backgroundColor: '#0f0f1a', color: '#e5e7eb', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      {/* Sidebar */}
      <div style={{ width: sidebarWidth + 'px', borderRight: '1px solid #2a2a3f', display: 'flex', flexDirection: 'column' }}>
        {/* Header */}
        <div style={{ padding: '16px', borderBottom: '1px solid #2a2a3f' }}>
          {editingPrepName ? (
            <input
              autoFocus
              value={prep.name}
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '8px' }}>
          <div
            ...
            style={{
              padding: '8px',
              marginBottom: '8px',
              backgroundColor: !selectedNodeId ? '#2a2149' : 'transparent',
              borderRadius: '4px',
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
      ...
      <div
        ...
        style={{ width: '4px', cursor: 'col-resize', backgroundColor: isResizing ? '#8b5cf6' : '#2a2a3f' }}
      />
